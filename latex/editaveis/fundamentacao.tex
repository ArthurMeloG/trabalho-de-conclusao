...
\section{características de um bom Chatbot}
No desenvolvimento de um chatbot, é fundamental a preocupação em enriquecer os sistemas com características sociais, afim de alinhar as expectativas dos utilizadores e evitar frutrações dos usuários. Com isso, o estudo "How should my chatbot interact? A survey on social characteristics in human-chatbot interaction design (preprint)" de Ana Paula Chaves e Marco Aurelio Gerosa identificou 11 características sociais, agrupadas em três categorias principais, que são consideradas valiosas para o desenvolvimento de chatbots:

1. Inteligência Conversacional: esta categoria agrupa características que permitem os chatbots gerirem bem as conversas, demonstrando assim domínio a cerca do tópico abordado na interação com o usuário. As qualidades mais relevantes desse conjunto são: 
\begin{itemize}
    \item \textbf{Proatividade}: capacidade do chatbot sugerir novos tópicos, fornecer informações adicionais ou formular perguntas de acompanhamento. Isso reduz o esforço do utilizador, tornando a interação mais natural.
    \item \textbf{Conscienciosidade}: capacidade do software de manter a conversa no caminho desejado, demonstrando compreensão a cerca do tema tratado. 
    \item \textbf{Comunicabilidade}: capacidade do chatbot de desvendar funcionalidades e gerir as expectativas do utilizador.
\end{itemize}

2. inteligência social: esta categoria agrupa as propriedades que tornam as interações mais agradáveis do ponto de vista social habitual. As mais relevantes são:
\begin{itemize}
    \item \textbf{Maneiras}: capacidade do chatbot de adequar sua linguagem, podendo até ter senso de humor.
    \item \textbf{Agência Moral}: especialmente em domínios sensíveis, a moralidade pode aumentar a credibilidade e enriquecer as interações.
    \item \textbf{Controle de Danos}: habilidade do chatbot identificar e lidar com usuários hostis e declarações abusivas. Isso é fundamental para manter um ambiente positivo e construtivo.
\end{itemize}

3. Personificação: esta categoria agrupa características que constroem as representações de personalidade do chatbot. Elas influenciam como os usuários se relacionam com ele. As principais são:
\begin{itemize}
    \item \textbf{Personalização}: capacidade de aprender com e sobre o utilizador e fornecer respostas personalizadas.
    \item \textbf{Personalidade}: capacidade de elaboração de uma persona para o chatbot. Uma personalidade bem definida pode aumentar o envolvimento e a semelhança humana percebida, embora o artigo alerte para o risco de humanização excessiva que pode levar a expectativas irrealistas.
    \item \textbf{Identidade}: capacidade de gerar clareza sobre o propósito do chatbot e sugerir os próximos passos.
\end{itemize}
